...
namespace ASALI
{
    Kila::Kila(Cantera::ThermoPhase* thermo,
      ...
      transport_(transport)
    {
        ...
        for (unsigned int i=0;i<exitButton_.size();i++)
        {
            ...
            exitButton_[i]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::exit));
        ...
        logoEventBox_.signal_button_press_event().connect(sigc::mem_fun(*this,&Kila::menu));
        logoEventBox_.signal_realize().connect(sigc::mem_fun(*this,&Kila::changeCursor));
        ...
        startButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::backToMenu));
        ...
        discrimerButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::discrimer));
        ...
        //Menu
        {
            ...
            transportButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::transportMenu));
            buttonsBox_.pack_start(thermoButton_, Gtk::PACK_SHRINK);
            thermoButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::thermoMenu));
            buttonsBox_.pack_start(allButton_, Gtk::PACK_SHRINK);
            allButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::allMenu));
            buttonsBox_.pack_start(equilibriumButton_, Gtk::PACK_SHRINK);
            equilibriumButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::equilibriumMenu));
            buttonsBox_.pack_start(reactorsButton_, Gtk::PACK_SHRINK);
            reactorsButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::reactorsMenu1));
        ...
        //Input menu
        {
            ...
            backButton_[0]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::backToMenu));
            
            //Done buttons
            doneThermoButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::thermoResults));
            doneTransportButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::transportResults));
            doneAllButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::allResults));
            nextButton_[0]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::reactorsMenu2));
            nextButton_[2]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::equilibriumResults));
        }
        ...
        //Reactors menu
        {
            ...
            //Buttons
            {
                ...
                backButton_[5]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::reactorsMenu1));
                reactorsButtonGrid_[0]->attach(equationsButton_,1,0,1,1);
                equationsButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::equations));
                reactorsButtonGrid_[0]->attach(loadKineticButton_,2,0,1,1);
                loadKineticButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::loadKineticInput));
                ...
                reactorSaveButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::saveKineticInput));
                reactorsButtonGrid_[1]->attach(runButton_,2,NR_,1,1);
                runButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::runReactors));
        ...
        //Thermo results menu
        {
            backButton_[1]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::thermoMenu));
            thermoSaveButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::thermoSave));
        }
        
        //Transport results menu
        {
            backButton_[2]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::transportMenu));
            transportSaveButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::transportSave));
        }

        //All results menu
        {
            backButton_[3]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::allMenu));
            allSaveButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::allSave));
        }
        ...
        //Results
        {
            ...
            cpCombo_.signal_changed().connect(sigc::bind<bool>(sigc::mem_fun(*this,&Kila::cpUnitConversion),true));
            ...
            sCombo_.signal_changed().connect(sigc::bind<bool>(sigc::mem_fun(*this,&Kila::sUnitConversion),true));
            ...
            hCombo_.signal_changed().connect(sigc::bind<bool>(sigc::mem_fun(*this,&Kila::hUnitConversion),true));
            ...
            condCombo_.signal_changed().connect(sigc::bind<bool>(sigc::mem_fun(*this,&Kila::condUnitConversion),true));
            ...
            muCombo_.signal_changed().connect(sigc::bind<bool>(sigc::mem_fun(*this,&Kila::muUnitConversion),true));
            ...
            diffCombo_.signal_changed().connect(sigc::bind<bool>(sigc::mem_fun(*this,&Kila::diffUnitConversion),true));
        }
        ...
        //Equilibrium menu
        {
            ...
            equilibriumCombo_.signal_changed().connect(sigc::mem_fun(*this,&Kila::equilibriumRun));
            ...
            initialFractionCombo_.signal_changed().connect(sigc::mem_fun(*this,&Kila::initialFractionUnitConversion));
            ...
            finalFractionCombo_.signal_changed().connect(sigc::mem_fun(*this,&Kila::finalFractionUnitConversion));


            exitButton_[8]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::exit));
            backButton_[8]->signal_clicked().connect(sigc::mem_fun(*this,&Kila::equilibriumMenu));
            equilibriumSaveButton_.signal_clicked().connect(sigc::mem_fun(*this,&Kila::equilibriumSave));
        }
    }
    ...
    void Kila::cpUnitConversion(bool check)
    {
        if ( check == true )
        {
            if ( window_ == "thermo" )
    ...
    void Kila::hUnitConversion(bool check)
    {
        if ( check == true )
        {
            if ( window_ == "thermo" )
    ...
    void Kila::sUnitConversion(bool check)
    {
        if ( check == true )
        {
            if ( window_ == "thermo" )
    ...
    void Kila::condUnitConversion(bool check)
    {
        if ( check == true )
        {
            if ( window_ == "transport" )
    ...
    void Kila::muUnitConversion(bool check)
    {
        if ( check == true )
        {
            if ( window_ == "transport" )
    ...
    void Kila::diffUnitConversion(bool check)
    {
        if ( check == true )
        {
            if ( window_ == "transport" )
        ...
        { 
            ...
            speciesCombo_[i]->signal_changed().connect(sigc::bind<unsigned int>(sigc::mem_fun(*this,&Kila::diffSpecies),i));
    ...
    void Kila::diffSpecies(unsigned int row)
    {
        double converter = 0.;
    ...
    void Kila::finalFractionUnitConversion()
    {
    ...
    void Kila::initialFractionUnitConversion()
    {
    ...
    void Kila::checkInput(unsigned int i)
    {
        if ( i == 4444 )
        {
    ...
    std::vector<bool> Kila::setReactors()
    {
    ...
    unsigned int Kila::specieIndex(const std::string n, const std::vector<std::string> v)
    {
        unsigned int id;
    ...
    bool Kila::reactionInputCheck(bool test)
    {
        bool check = false;
